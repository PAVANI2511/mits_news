"""
Django settings for mits_news project.
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-^5nmv8ypu)__1yf78da%f%o6enjbd%p@am@wh3do$mccyx=&bh')

DEBUG = os.getenv('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = [host.strip() for host in os.getenv('ALLOWED_HOSTS', '*').split(',') if host.strip()]

# Reverse proxy configurations for secure HTTPS URLs in production
...
# Define dummy credentials to avoid django-cloudinary-storage setup failures when running checks locally
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': CLOUDINARY_CLOUD_NAME or 'dummy_cloud',
...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'mitsnews691a@gmail.com')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'oajsuxyvgzoghnza')

...
urlpatterns = [
    ...
    path('reports/<int:pk>/', AdminReportDetailView.as_view(), name='admin_report_detail'),
    ...
    path('analytics/export/csv/', AdminAnalyticsExportCSVView.as_view(), name='admin_analytics_export_csv'),

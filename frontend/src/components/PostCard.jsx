    ...
    >
      ...
      {visualMedia.length > 0 && (
        <div className="media-block overflow-hidden border border-border bg-bg/25 w-full">
          <div 
            className="relative w-full aspect-video sm:aspect-square md:max-h-[500px] bg-card flex items-center justify-center overflow-hidden rounded-2xl border border-border/80 select-none group"
        ...
        <div className="flex gap-2.5 w-full sm:w-auto shrink-0 items-center">
          {!isOwner && (
            <>
              ...
              <button
                onClick={() => handleInterestSelection('not_interested')}
                className={`flex-1 sm:flex-initial px-4 py-2.5 rounded-xl text-xs font-bold transition-all duration-200 flex items-center justify-center gap-2 active:scale-95 shadow-sm ${
